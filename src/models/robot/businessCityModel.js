import {
  ...
  update,
  pageCount
} from '@/services/robot/businessCityApi';

export default {
  namespace: 'businessCityModel', // 这个是标示当前model的
  ...
  effects: {
    ...
    *tableFresh({payload}, { put }) {
      // console.log('businessCityModel.tableFresh 参数：');
    ...
    *add({ payload }, { call, put }) {
      // console.log('businessCityModel.add 参数：');
      // console.log(JSON.stringify(payload));
    ...
    *delete({ payload }, { call, put }) {
      // console.log('businessCityModel.delete 参数：');
      // console.log(JSON.stringify(payload));
    ...
    *update({ payload }, { call, put }) {
      // console.log('businessCityModel.update 参数：');
      // console.log(JSON.stringify(payload));
    ...
    *pageList({ payload }, { call, put }) {
      // console.log('businessCityModel.pageList 参数：');
      // console.log(JSON.stringify(payload));
      ...
      // console.log('businessCityModel.pageList 结果：');
      yield put({
    ...
    *pageCount({ payload }, { call, put }) {
      // console.log('businessCityModel.pageCount 参数：');
      // console.log(JSON.stringify(payload));
  ...
  reducers: {
    ...
    handleCountResult(state, action) {
      // console.log('businessCityModel.handleCountResult 返回的结果');
    ...
    handlePageListResult(state, action) {
      // console.log('businessCityModel.handlePageListResult 返回的结果');
    ...
    handleUpdateResult(state, action) {
      // console.log('businessCityModel.handleUpdateResult 返回的结果');
      // console.log(JSON.stringify(action.payload));
    ...
    handleDeleteResult(state, action) {
      // console.log('businessCityModel.handleDeleteResult 返回的结果');
