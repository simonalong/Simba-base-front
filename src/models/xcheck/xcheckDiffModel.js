import {
  pageList,
  pageCount
} from '@/services/xcheck/xcheckDiffApi';

export default {
  namespace: 'xcheckDiffModel', // 这个是标示当前model的
  ...
  effects: {
    ...
    *tableFresh({ payload }, { put }) {
      // console.log('xcheckDiff.tableFresh 参数：');
    ...
    *pageList({ payload }, { call, put }) {
      // console.log('xcheckDiff.pageList 参数：');
      // console.log(JSON.stringify(payload));
      ...
      // console.log('xcheckDiff.pageList 结果：');
      yield put({
    ...
    *pageCount({ payload }, { call, put }) {
      // console.log('xcheckDiff.pageCount 参数：');
      // console.log(JSON.stringify(payload));
  ...
  reducers: {
    ...
    handleCountResult(state, action) {
      // console.log('xcheckDiff.handleCountResult 返回的结果');
    ...
    handlePageListResult(state, action) {
      // console.log('xcheckDiff.handlePageListResult 返回的结果');
