import {
  pageList,
  pageCount
} from '@/services/xcheck/xcheckTaskApi';

export default {
  namespace: 'xcheckTaskModel', // 这个是标示当前model的
  ...
  effects: {
    ...
    *tableFresh({ payload }, { put }) {
      // console.log('xcheckTask.tableFresh 参数：');
    ...
    *pageList({ payload }, { call, put }) {
      // console.log('xcheckTask.pageList 参数：');
      // console.log(JSON.stringify(payload));
      ...
      // console.log('xcheckTask.pageList 结果：');
      yield put({
    ...
    *pageCount({ payload }, { call, put }) {
      // console.log('xcheckTask.pageCount 参数：');
      // console.log(JSON.stringify(payload));
  ...
  reducers: {
    ...
    handleCountResult(state, action) {
      // console.log('xcheckTask.handleCountResult 返回的结果');
    ...
    handlePageListResult(state, action) {
      // console.log('xcheckTask.handlePageListResult 返回的结果');
