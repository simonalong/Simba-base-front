import {
  ...
  update,
  pageCount
} from '@/services/portal/businessMemberApi';

export default {
  namespace: 'businessMemberModel', // 这个是标示当前model的
  ...
  effects: {
    ...
    *tableFresh({ payload }, { put }) {
      // console.log('businessMember.tableFresh 参数：');
    ...
    *add({ payload }, { call, put }) {
      // console.log('businessMember.add 参数：');
      // console.log(JSON.stringify(payload));
    ...
    *delete({ payload }, { call, put }) {
      // console.log('businessMember.delete 参数：');
      // console.log(JSON.stringify(payload));
    ...
    *update({ payload }, { call, put }) {
      // console.log('businessMember.update 参数：');
      // console.log(JSON.stringify(payload));
    ...
    *pageList({ payload }, { call, put }) {
      console.log('businessMember.pageList 参数：');
      console.log(JSON.stringify(payload));
      ...
      console.log('businessMember.pageList 结果：');
      yield put({
    ...
    *pageCount({ payload }, { call, put }) {
      // console.log('businessMember.pageCount 参数：');
      // console.log(JSON.stringify(payload));
  ...
  reducers: {
    ...
    handleCountResult(state, action) {
      console.log('businessMember.handleCountResult 返回的结果');
    ...
    handlePageListResult(state, action) {
      console.log('businessMember.handlePageListResult 返回的结果');
    ...
    handleUpdateResult(state, action) {
      console.log('businessMember.handleUpdateResult 返回的结果');
      console.log(JSON.stringify(action.payload));
    ...
    handleDeleteResult(state, action) {
      // console.log('businessMember.handleDeleteResult 返回的结果');
    ...
    addPane(state, action) {
      // console.log('businessMember.addPane 参数：');
      // console.log(JSON.stringify(action));
      return {
        ...state,
    ...
    deletePaneActive(state, action) {
      console.log('businessMember.deletePaneActive 参数：');
    ...
    deletePane(state, action) {
      console.log('businessMember.deletePane 参数：');
      console.log(JSON.stringify(action.payload.activePaneName));
      return {
        ...state,
        panes: action.payload.panes,
    ...
    activePane(state, action) {
      // console.log('businessMember.activePane 参数：');
      // console.log(JSON.stringify(action));
      return {
        ...state,
