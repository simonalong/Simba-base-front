import {
  ...
  update,
  pageCount
} from '@/services/barrier/appGroupApi';

export default {
  namespace: 'appGroupModel', // 这个是标示当前model的
  ...
  effects: {
    ...
    *tableFresh({payload}, { put }) {
      // console.log('appGroupModel.tableFresh 参数：');
    ...
    *add({ payload }, { call, put }) {
      // console.log('appGroupModel.add 参数：');
      // console.log(JSON.stringify(payload));
    ...
    *delete({ payload }, { call, put }) {
      // console.log('appGroupModel.delete 参数：');
      // console.log(JSON.stringify(payload));
    ...
    *update({ payload }, { call, put }) {
      // console.log('appGroupModel.update 参数：');
      // console.log(JSON.stringify(payload));
    ...
    *pageList({ payload }, { call, put }) {
      // console.log('appGroupModel.pageList 参数：');
      // console.log(JSON.stringify(payload));
      ...
      // console.log('appGroupModel.pageList 结果：');
      yield put({
    ...
    *pageCount({ payload }, { call, put }) {
      // console.log('appGroupModel.pageCount 参数：');
      // console.log(JSON.stringify(payload));
  ...
  reducers: {
    ...
    handleCountResult(state, action) {
      // console.log('appGroupModel.handleCountResult 返回的结果');
    ...
    handlePageListResult(state, action) {
      // console.log('appGroupModel.handlePageListResult 返回的结果');
    ...
    handleUpdateResult(state, action) {
      // console.log('appGroupModel.handleUpdateResult 返回的结果');
      // console.log(JSON.stringify(action.payload));
    ...
    handleDeleteResult(state, action) {
      // console.log('appGroupModel.handleDeleteResult 返回的结果');
