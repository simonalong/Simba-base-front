...
import findRoute, {
  getUrlQuery,
} from '/Users/zhouzhenyong/project/isyscore/isc-front-base/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3001,
      path: '/Users/zhouzhenyong/project/isyscore/isc-front-base',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
